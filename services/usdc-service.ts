...
import { USDC_MINT_ADDRESS, CURRENT_NETWORK, PLATFORM_WALLET_ADDRESS } from "@/config/solana"
...
export class USDCService {
  ...
  constructor(connection?: Connection) {
    ...
    // Use the correct USDC mint address
    this.usdcMintAddress = USDC_MINT_ADDRESS
